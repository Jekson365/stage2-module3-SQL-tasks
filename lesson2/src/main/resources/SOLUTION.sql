...
INSERT INTO Subject (id, name, description, grade) VALUES
    (1, 'Art and music', 'Art and music subject', 1),
    (2, 'Geography', 'Geography subject', 2),
    (3, 'History', 'History subject', 2),
    (4, 'PE', 'Physical Education subject', 3),
    (5, 'Math', 'Math subject', 3),
    (6, 'Science', 'Science subject', 4),
    (7, 'IT', 'Information Technology subject', 4);
